...
const openChest = () => {
    // TODO: This may not be true any more
...
const letter = new Item()
    ...
    .setUse(() => "You made a paper plane.... that was fun. Lets continue the adventure")
    .on("read", () => letterText);

const scroll = new Item()
    .setLook(() => "It's an old scroll. " +
        "Looks like you can read it.")
    .setTake(() => {
